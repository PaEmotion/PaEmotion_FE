...
class BudgetAiChatScreen extends StatefulWidget {
  const BudgetAiChatScreen({super.key});

  @override
  State<BudgetAiChatScreen> createState() => _BudgetAiChatScreenState();
}

class _BudgetAiChatScreenState extends State<BudgetAiChatScreen> {
  ...
  void _sendMessage() {
    ...
    Future.delayed(const Duration(milliseconds: 500), () {
      setState(() {
        _messages.add(ChatMessage(
          text: "예산 설정 AI가 '$text' 에 대해 답변하는 중...",
          isUser: false,
          time: DateTime.now(),
        ));
      });
